 ...
 *
 * The purpose of distinguishing this type of error is that it will not show up in CloudWatch, when used with [simple-lambda-handler](https://github.com/uladkasach/simple-lambda-handler).
 *
